...
async function fetchProducts(queryData, userData) {
    try {
        let { active = undefined, skip = undefined, limit = undefined, search,
            categoryId, subCategoryId, specificCategoryIds, colors, sizes, isReject = undefined, isBlocked = undefined } = queryData;
        let condition = { isDeleted: false, active: true, isPublic: true, isReject: false }
        if (categoryId) {
